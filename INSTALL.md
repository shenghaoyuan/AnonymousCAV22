...
```shell
# assume your ubuntu is named `YOUR_NAME`
# current folder: /home/YOUR_NAME/CertrBPF
...
#  ==> ./home/YOUR_NAME/.opam
# 2); adding the line: `export PATH=$PATH:/home/YOUR_NAME/.opam/bpf/bin:/home/YOUR_NAME/CertrBPF/coq2html`
# 3); adding the line `export COQPATH="$(opam var lib)/coq-variant/compcert32"`
vim /home/YOUR_NAME/.bashrc
...
# Build CertrBPF
```shell
# current folder: /home/YOUR_NAME/CertrBPF/dx
# install CertrBPF
cd ..
git clone THIS_REPO
cd rbpf-dx
...
# -R /home/YOUR_NAME/.opam/bpf/lib/coq-variant/compcert32/compcert compcert
# ===>
# -R /home/YOUR_NAME/.opam/bpf/lib/coq-variant/compcert32/compcert compcert
vim _CoqProject

# modify the file `Makefile.config` and `verifier/Makefile.config`:
# OPAMPREFIX := /home/YOUR_NAME/.opam/bpf
# ===>
# OPAMPREFIX := /home/YOUR_NAME/.opam/bpf
vim Makefile.config
